...
function PANEL:AddSheet( label, panel, material, NoStretchX, NoStretchY, Tooltip )
	...
	Sheet.Tab:SetTextColor(color_white)
	Sheet.Tab:TDLib():Background(Color(35, 35, 35)):Outline(Color(64, 64, 64)):FadeHover()
...
derma.DefineControl( "DPropertyFusion", "", PANEL, "Panel" )
