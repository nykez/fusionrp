...
ITEM.functions.EquipUn = { -- sorry, for name order.
	...
	onRun = function(item)
		...
		if (weapon and weapon:IsValid()) then
			...
			print(Format("[Fusion] Weapon %s does not exist!", item.class))
		end
...
function ITEM:onLoadout()
	if (self:getData("equip")) then
		...
		if (IsValid(weapon)) then
			...
			print(Format("[Fusion] Weapon %s does not exist!", self.class))
		end
	end
end
...
hook.Add("PlayerDeath", "fusionStripClip", function(client)
	client.carryWeapons = {}
